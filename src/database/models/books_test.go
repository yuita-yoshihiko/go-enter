...
var (
	bookDBTypes = map[string]string{`ID`: `character varying`, `Title`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
