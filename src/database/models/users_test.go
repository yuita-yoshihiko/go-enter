...
var (
	userDBTypes = map[string]string{`ID`: `integer`, `Name`: `character varying`, `Password`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
