...
func (o *Like) Book(mods ...qm.QueryMod) bookQuery {
...
func (likeL) LoadBook(ctx context.Context, e boil.ContextExecutor, singular bool, maybeLike interface{}, mods queries.Applicator) error {
	var slice []*Like
	var object *Like
...
// SetBook of the like to the related item.
// Sets o.R.Book to related.
// Adds o to related.R.Likes.
func (o *Like) SetBook(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Book) error {
	var err error
	if insert {
